        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          {(["general", "specialized"] as const).map((t) => (
            ...
            >
              ...
              <div className="mb-1">{t === "general" ? <Zap className="size-5" /> : <Globe className="size-5" />}</div>
        ...
        {sessionType === "specialized" && (
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {allowedTabs.map((tab) => (
                <span key={tab} className="flex items-center gap-1 px-3 py-1 bg-orange-500/10 text-orange-500 rounded-full text-sm">
                  {tab}
